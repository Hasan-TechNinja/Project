...
urlpatterns = [
    ...
    # path('shop/<int:pk>/', views.ShopView.as_view(), name='shop_by_department'),
    ...
    path('departments/<int:pk>/', views.DepartmentsView.as_view(), name='department_detail'),
    path('categories/', views.CategoryView.as_view(), name='categories'),
    path('categories/<int:pk>/', views.CategoryView.as_view(), name='category'),  # Change name here
